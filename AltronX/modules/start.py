...
PythonButton = [
        ...
        [
        Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", "https://t.me/Kittyxupdates"),
        Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", "https://t.me/Grandxmasti")
        ],
        [
        Button.url("⚡️🇲σ᭡፝֟ɳ🌙", "https://t.me/Moonshining2")
        ]
        ]
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» **✦ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗗 𝗕𝗬 :~ [🇲σ᭡፝֟ɳ🌙](https://t.me/Moonshining2)**\n\n"
