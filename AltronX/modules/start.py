...
PythonButton = [
        ...
        [
        Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", "https://t.me/Moonshining_Society"),
        Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", "https://t.me/TheWarriorsxNetwork")
        ],
        [
        Button.url("⚡️𝐌ᴏᴏɴ⚡️", "https://t.me/About_ur_Moonshining")
        ]
        ]
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» **✦ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗗 𝗕𝗬 :~ [𝐌ᴏᴏɴ](https://t.me/Moonshining6)**\n\n"
